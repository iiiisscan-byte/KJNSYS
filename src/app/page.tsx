    ...
    <>
      ...
      <section id="about" className={styles.aboutSection}>
        <div className={styles.aboutContainer}>
          <h3 className={styles.subTitle}>케이제이엔시스 회사소개</h3>
          <h2 className={styles.mainTitle}>
            혁신적인 기술로 더 나은 디지털 미래를 만듭니다
          </h2>
      ...
      <section id="promotions" className={styles.promotionSection}>
        <div className="container">
          <div className={styles.promotionHeader}>
            <h3 className={styles.promoSubTitle}>PROMOTION</h3>
            <h2 className={styles.promoMainTitle}>진행중인 특별 프로모션</h2>
          </div>
